...
ActiveRecord::Schema[7.1].define(version: 2024_05_11_122515) do
  ...
  create_table "chats", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["application_id", "num"], name: "index_chats_on_application_id_and_num", unique: true
  ...
  create_table "messages", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chat_id", "num"], name: "index_messages_on_chat_id_and_num", unique: true
